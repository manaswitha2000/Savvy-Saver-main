...
class Product(models.Model):
    ...
    price_amazon = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    price_flipkart = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    price_jiomart = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
